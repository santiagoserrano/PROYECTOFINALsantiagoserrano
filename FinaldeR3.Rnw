...
###
hist(colb$cabeLog,main="Logaritomo de la poblacion cabecera",ylab="Frecuencia",col="YELLOW")
###

hist(colb$restoLog,main="Logaritmo de la poblacion resto",ylab="Frecuencia",col="YELLOW")
###
...
stargazer(corrTableX,title="Correlaci\'on entre las variables independientes")
@
...
plot(colb[,explanans],xlab= "Logaritmo P. Cabecera", ylab="Logaritmo de P. Restante")
...
#summary(LinRegA)
#summary(LinRegB)
stargazer(LinRegA,LinRegB,title="Modelos de Regresi\'on",label="regresiones")
@
